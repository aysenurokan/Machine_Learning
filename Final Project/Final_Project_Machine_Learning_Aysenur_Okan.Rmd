...
rf=randomForest(SI_Binary~.-id,data=df,mtry=3,ntree=400) #use 3 vars at a time (3 random predictors as candidates to split on), 400 trees grown in bootstrapped datasets. 
...
## Grow a random forest with randomForest() to predict SI_Binary, and try 5 tuning parameters and the previously-specified cross-validation routine.
```{r}
set.seed(2000)
#Fit Model 
